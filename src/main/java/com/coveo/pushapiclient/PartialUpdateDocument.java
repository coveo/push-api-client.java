...
public class PartialUpdateDocument {
    ...
    /**
     * Creates a new PartialUpdateDocument. The type of the value provided is constrained by the operator.
     *
     * <ul>
     * <li>PartialUpdateOperator.ARRAY_APPEND: value must be an array</li>
     * <li>PartialUpdateOperator.ARRAY_REMOVE: value must be an array</li>
     * <li>PartialUpdateOperator.FIELD_VALUE_REPLACE: value can be any type</li>
     * <li>PartialUpdateOperator.DICTIONARY_PUT: value must be a Map</li>
     * <li>PartialUpdateOperator.DICTIONARY_REMOVE: value must be a String or an Array</li>
     * </ul>
     *
     ...
     */
    public PartialUpdateDocument(String documentId, PartialUpdateOperator operator, String field, Object value) {
        ...
        switch (operator) {
            ...
            case DICTIONARYREMOVE:
                if (!(value instanceof String) && !value.getClass().isArray())
                    throw new IllegalArgumentException("Value must be a String or an Array for operator " + operator);
                break;
            default:
