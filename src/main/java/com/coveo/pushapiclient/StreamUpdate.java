...
public class StreamUpdate extends BatchUpdate {
    ...
    public StreamUpdate(List<DocumentBuilder> addOrUpdate, List<DeleteDocument> delete, List<PartialUpdateDocument> partialUpdate) {
    ...
    public String toString() {
        return "StreamUpdate[" + "addOrUpdate=" + getAddOrUpdate() + ", delete=" + getDelete() + ", partialUpdate=" + partialUpdate + ']';
    }
    ...
    public boolean equals(Object obj) {
        ...
        return getAddOrUpdate().equals(that.getAddOrUpdate()) && getDelete().equals(that.getDelete()) && partialUpdate.equals(that.partialUpdate);
    }
