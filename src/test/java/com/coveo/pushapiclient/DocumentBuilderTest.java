...
public class DocumentBuilderTest {
  ...
  public void testWithCompressedBinaryData() {
    String encoded =
        Base64.getEncoder().encodeToString("binary data encoded".getBytes(StandardCharsets.UTF_8));
    docBuilder.withCompressedBinaryData(
        new CompressedBinaryData(encoded, CompressionType.UNCOMPRESSED));
    String decoded =
        new String(
            Base64.getDecoder()
                .decode(
                    docBuilder
                        .marshalJsonObject()
                        .get("compressedBinaryData")
                        .getAsString()
                        .getBytes(StandardCharsets.UTF_8)));

    assertEquals(
        "withCompressedBinaryData should marshal correctly", "binary data encoded", decoded);
  }
  ...
  public void testWithClickableUri() {
    ...
    assertEquals(
        "withClickableUri should marshal correctly",
        "the click uri",
  ...
  public void testWithAuthor() {
    ...
    assertEquals(
        "withAuthor should marshal correctly",
        "the author",
  ...
  public void testWithMetadata() {
    ...
    assertEquals(false, docBuilder.marshalJsonObject().get("my_field_2").getAsBoolean());
  ...
  public void testWithMultipleAllowedPermissions() {
    docBuilder.withAllowedPermissions(
        new UserSecurityIdentityBuilder(new String[] {"bob@anonymous.com", "john@anonymous.com"}));
  ...
  public void testWithMultipleDeniedPermissions() {
    docBuilder.withDeniedPermissions(
        new UserSecurityIdentityBuilder(new String[] {"bob@anonymous.com", "john@anonymous.com"}));
  ...
  public void marshal() {
    ...
    assertTrue(
        "marshal should return a valid JSON string", docBuilder.marshal().contains("the_title"));
  }
}
